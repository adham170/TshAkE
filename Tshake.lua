...
local UserName = (data.username_ or "FAQY4")
...
local url,res = http.request('http://adham.ml/joinch/?id='..msg.sender_user_id_)
...
local UserName = (b.username_ or "FAQY4")
...
if text == (database:get(bot_id.."Tshake:Name:Bot") or "فلاش") then
Namebot = (database:get(bot_id.."Tshake:Name:Bot") or "فلاش")
local namebot = {
...
download_to_file('https://raw.githubusercontent.com/adham170/Tshake/master/Tshake.lua', 'Tshake.lua') 
download_to_file('https://raw.githubusercontent.com/adham170/Tshake/master/start.lua', 'start.lua') 
dofile('Tshake.lua')  
return false
end
...
if DevTshake(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/adham170/files_tshake/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n📂┇اهلا بك في متجر ملفات فلاش \n📮┇الملفات الموجوده حاليا \nꔹ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ꔹ\n\n"
...
local json_file, res = https.request("https://raw.githubusercontent.com/adham170/files_tshake/master/files_tshake/"..file)
if res == 200 then
...
🌐┇TshAkE TEAM 
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
📊┇ [Source Channel](https://t.me/FAQY4)

📋┇ [TshAkE Dev](https://t.me/FAQY4)

📁┇ [Source  Files](https://t.me/Tshake_sudo)

🌐┇ [TshAkE iNDT](https://t.me/FAQY4/4611)
...
local Name_Bot = (database:get(bot_id.."Tshake:Name:Bot") or "فلاش")
